...
urlpatterns = [
    ...
    path('form/register/bymonth/<int:year>/<int:center_id>', views.CountInMonthByCenter, name="center"),
    # lấy data của từng tháng trong 1 năm bất kỳ
    # cục (toàn quốc)
    # trung tâm (của trung tâm đấy)
    ...
    path('form/register/byyear/all/<int:center_id>', views.CountInYearAll),

    path('form/register/all', views.CountAllByCenter, name="center"),
    path('form/register/all/<int:center_id>', views.CountAllByCenter, name="center"),
    path('form/expired/all', views.ExpiredAllByCenter, name="center"),
    path('form/expired/all/<int:center_id>', views.ExpiredAllByCenter, name="center"),
    ...
    path('form/expiring/all/<int:center_id>', FormExpiringView.as_view()),
